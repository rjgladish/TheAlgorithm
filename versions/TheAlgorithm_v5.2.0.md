...
`[N]` ≥1 and `[A]` ≥1-when-experiential are required as stated in the category table above; the model picks everything else (mix of categories, capability count, thinking vs. delegation balance).
