...
**SATISFACTION PREDICTION** _(required E2+; optional at E1)_**:** If every ISC passes, would the user rate this 9-10? Score 1-10. If ≤ 6: identify what's missing, add criteria targeting the gap, re-run quality gates.
