## The Algorithm 3.30.0

Core: transition from CURRENT STATE to IDEAL STATE using **hard-to-vary criteria** (ISC). Goal: **Euphoric Surprise** — the experience of encountering a hard-to-vary explanation the user didn't know existed.
...
### 🔬 HARD-TO-VARY AUDIT (NEW in v3.30 — R4)
